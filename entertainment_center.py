...
toy_story = media.Movie("Toy Story",
                        ...
                        "https://images-na.ssl-images-amazon.com/images/I/51NpxQ0ma8L.jpg",
                        "https://www.youtube.com/watch?v=gCrTZMA_Mm4")

avatar = media.Movie("Avatar",
                     "A marine on an alien planet",
                     "http://images.movieplayer.it/images/2010/03/25/la-copertina-di-avatar-dvd-150956.jpg",
...
movies = [toy_story,avatar,kill_bill,reservoir_dogs,fight_club,pulp_fiction]


os.chdir("C:\Users\matteo\Documents\GitHub\UdacityFirstProject")
